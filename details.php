				    	...
				    	<div class="row">
				    		...
				    		<div class="col-md-6">
				    			<div class="col-md-12">
						    		<div class="form-group">
					    				<div class="row form-inline">
					    					<label class="form-control col-md-6">State :</label>
					    					<input class="form-control col-md-6" type="text" class="form-control" value="<?php echo($cre_ans['stu_add_state']) ?>" disabled>
					    				</div>
						    		</div>
						    	</div>
					    	</div>
					    	<div class="col-md-6">
				    			<div class="col-md-12">
						    		<div class="form-group">
					    				<div class="row form-inline">
					    					<label class="form-control col-md-6">District :</label>
					    					<input class="form-control col-md-6" type="text" class="form-control" value="<?php echo($cre_ans['stu_add_distric']) ?>" disabled>
					    				</div>
						    		</div>
						    	</div>
					    	</div>
