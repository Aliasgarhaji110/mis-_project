<?php  
	...
	else if(!preg_match("/^[12][90][0-9][0-9]$/",$_POST['stu_year_of_joining'])) echo("Please Enter Year of Joining");
	else if (($_POST['stu_add1']== NULL)||($_POST['stu_add_locality']== NULL)||($_POST['stu_add_city']== NULL)||($_POST['stu_add_state']== NULL)||($_POST['stu_add_district']== NULL)) echo $msg ="Please fill all details";
